  ...
  <head>
   ...
   <script>
       $(document).ready(function() {
            ...
            $("#load_php").load("show_users.php", 'r='+Math.random());
       })
       </script>
<style>
    #posting{
...
<a href = "../programming.html">Back to USSR</a>
<!--<form method="post">
Input name <input type="text" name="search_user_name" id="search_user_name" />
<input type="submit" name="search_user" value="search" class="btn btn-primary btn-xs"/> 
</form><hr />-->
